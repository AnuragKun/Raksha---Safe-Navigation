...
object AppModule {
    ...
    fun provideReportRepository(
        ...
        firebaseAuth: FirebaseAuth
    ): com.arlabs.raksha.domain.repository.ReportRepository {
        return com.arlabs.raksha.data.repositoryImpl.ReportRepositoryImpl(firestore, firebaseAuth)
    }
    ...
    fun provideTimerRepository(
        firestore: FirebaseFirestore,
        firebaseAuth: FirebaseAuth
    ): com.arlabs.raksha.domain.repository.TimerRepository {
        return com.arlabs.raksha.data.repositoryImpl.TimerRepositoryImpl(firestore, firebaseAuth)
    }
    ...
    fun provideEmergencyContactRepository(
        firestore: FirebaseFirestore,
        firebaseAuth: FirebaseAuth
    ): com.arlabs.raksha.domain.repository.EmergencyContactRepository {
        return com.arlabs.raksha.data.repositoryImpl.EmergencyContactRepositoryImpl(firestore, firebaseAuth)
    }
    ...
    fun provideSosRepository(
        firestore: FirebaseFirestore,
        firebaseAuth: FirebaseAuth
    ): com.arlabs.raksha.domain.repository.SosRepository {
        return com.arlabs.raksha.data.repositoryImpl.SosRepositoryImpl(firestore, firebaseAuth)
    }
}
